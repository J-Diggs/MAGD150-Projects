...
void setup() {
  ...
  front = loadImage("Grass.jpg");
  right = loadImage("Grass.jpg");
  back = loadImage("Grass.jpg");
  left = loadImage("Grass.jpg");
  bottom = loadImage("Dirt.png");
  top = loadImage("topOfGrass.png");
  txtr = loadImage("Diamond.png");
  
  //saves images used in sketch
  save("Grass.jpg");
  save("Dirt.png");
  save("topOfGrass");
  save("Diamond");
